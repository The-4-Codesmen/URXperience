...
function EventByDate() {
  ...
  const handleClick = () => {
    if (!dateValue) {
      ...
      axios
        .post(`${process.env.REACT_APP_SERVER}api/eventfind`, { date })
        .then((res) => {
  ...
  return (
    <div className="flex  text-center  relative  justify-center">
      <Navbar />
      <ToastContainer />
      <div className="event-div-circle absolute rounded-full top-60 left-50 ml-20 mt-20 w-80 h-80 bg-green-600 mix-blend-multiply opacity-20 filter blur-xl "></div>
      <div className="event-div-circle absolute rounded-full top-60 left-50 top-20  w-80 h-80 bg-yellow-200 mix-blend-multiply  opacity-20 filter blur-xl"></div>
      <div className="event-div-circle-2 absolute rounded-full top-60 left-50 mr-20  top-40  w-80 h-80 bg-indigo-500 mix-blend-multiply opacity-20 filter blur-xl"></div>
      <div className=" mt-4 m-4  flex text-center justify-center grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-3 xl:grid-cols-3 gap-10">
        ...
        <div className="  col-span-2 justify-center text-center m-4  p-2 ">
          <h1 className="   mt-20 mb-10 block text-black font-bold dark:text-dw w-full ">
            {" "}
            Avaliable Events
          </h1>
                ...
                <Carousel
                  ...
                  renderArrowPrev={(clickHandler, hasPrev) => {
                    return (
                      ...
                      >
                        <ArrowBackIosIcon
                          className=" flex-right leading-tight relative "
                          color="action "
                          fontSize="large"
                        ></ArrowBackIosIcon>
                      </div>
                        ...
                        <div className=" mb-10 mt-10 " key={e._id}>
                          ...
                          <div className="grid grid-cols-1 mr-20 ml-20 gap-2   sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3  xl:grid-cols-3 ">
                            <div className="m-6  box   bg-indigo-500 shadow-3xl  sm:bg-indigo-500 md:bg-indigo-500 lg:bg-indigo-500  xl:bg-indigo-500">
                              {/* sm: md: lg:  xl: */}
                              <p className=" mt-2 mb-2 font-bold  text-green-800  ">
                                From:{" "}
                          ...
                          <p className="mt-4  ml-4  font-light text-xs text-left font-bold text-green-800">
                            Posted By:{" "}
